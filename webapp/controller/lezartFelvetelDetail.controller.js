...
// sap.ui.controller("sap.ui.netlife.G4S.view.lezartFelvetelDetail", {
...
sap.ui.define([
	...
	return Controller.extend("com.g4s.controller.lezartFelvetelDetail", {
		...
		onInit: function() {
			...
			sap.ui.core.UIComponent.getRouterFor(this).getRoute("lezartFelvetelDetail").attachPatternMatched(this._onObjectMatched, this);
			this.getView().setModel(oViewModel, "lezartFelvetelDetailView");
		...
		_onObjectMatched: function(oEvent) {
			...
			var addressPath = oEvent.getParameter("arguments").lezartFelvetelDetailPath;
